...
\begin{tpinfo}[Résolution avec GeoGebra \& Calculatrice Casio / TI]{Vérifier une Équation}
\begin{enumerate}
    \item \textbf{GeoGebra (Calcul Formel - CAS)} :
    \begin{itemize}
        \item Ouvrir la vue \textbf{Calcul Formel}.
        \item Saisir la commande : \texttt{Résoudre(5x - 4 = 2x + 11)} et appuyer sur \textbf{Entrée}.
        \item Noter la solution affichée : \pointille[4cm]
        \item Saisir : \texttt{Résoudre((2x - 6)*(3x + 12) = 0)}. Noter les solutions : \pointille[4cm]
    \end{itemize}
    \item \textbf{Calculatrice (Menu Équation / Equation)} :
    \begin{itemize}
        \item Sur Casio fx-92+ : Menu \textbf{Équation} $\rightarrow$ \textbf{Système / Linéaire} ou \textbf{SolvN}.
        \item Résoudre à la machine l'équation $7x - 15 = 3x + 25$ et noter le résultat : $x = \pointille[2cm]$.
    \end{itemize}
\end{enumerate}
\end{tpinfo}
