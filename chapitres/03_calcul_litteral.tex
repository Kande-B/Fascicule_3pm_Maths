...
\begin{tpinfo}[Calcul Formel avec GeoGebra \& Calculatrice Casio / TI]{Vérifier un Développement}
\begin{enumerate}
    \item \textbf{GeoGebra (Calcul Formel - CAS)} :
    \begin{itemize}
        \item Ouvrir la vue \textbf{Calcul Formel} sur GeoGebra.
        \item Pour développer $(3x+4)(2x-5)$ : saisir \texttt{Développer((3x+4)*(2x-5))} et appuyer sur \textbf{Entrée}.
        \item Noter le résultat affiché : \pointille[6cm]
        \item Pour factoriser $6x^2 - 7x - 20$ : saisir \texttt{Factoriser(6x\^{}2 - 7x - 20)}.
    \end{itemize}
    \item \textbf{Vérification au Tableur / Calculatrice} :
    \begin{itemize}
        \item Tester avec $x = 10$ pour vérifier si le développement $(x+3)(x+2) = x^2 + 5x + 6$ est exact :
        \[ (10+3)(10+2) = 13 \times 12 = \pointille[2cm] \qquad 10^2 + 5 \times 10 + 6 = \pointille[2cm] \]
    \end{itemize}
\end{enumerate}
\end{tpinfo}
