...
\begin{exercice}[3 pts][\capRealiser]{Dallage en Béton d'une Terrasse \& Commande de Toupies (BTP)}
\noindent
\begin{minipage}[c]{0.58\linewidth}
Un artisan maçon réalise une dalle en béton rectangulaire de dimensions $L = 8\text{ m}$, $l = 4{,}50\text{ m}$ et d'épaisseur $e = 15\text{ cm}$ ($0{,}15\text{ m}$).
\begin{enumerate}[leftmargin=1.2em, itemsep=1pt]
    \item \capRealiser\ Calculer le volume théorique de béton en $\text{m}^3$.
    \item \capValider\ Pour pallier les pertes, le maçon majore ce volume de \textbf{$5\,\%$}. Quel volume doit-il commander ?
    \item \capRealiser\ Une toupie livre au maximum $6\text{ m}^3$. Déterminer le nombre de toupies nécessaires.
\end{enumerate}
\end{minipage}\hfill
...
\begin{exercice}[3 pts][\capSApproprier]{Fabrication \& Tôle d'une Boîte de Conserve Cylindrique}
\noindent
\begin{minipage}[c]{0.58\linewidth}
Une conserverie produit des boîtes cylindriques de rayon $r = 4\text{ cm}$ et hauteur $h = 11\text{ cm}$.
\begin{enumerate}[leftmargin=1.2em, itemsep=1pt]
    \item \capRealiser\ Calculer le volume en $\text{cm}^3$ et la contenance en $\text{cL}$ (arrondir à l'unité).
    \item \capRealiser\ Calculer l'aire totale de métal pour une boîte ($\text{Aire} = 2\pi r^2 + 2\pi r h$) en $\text{cm}^2$.
    \item \capValider\ Pour $10\,000$ boîtes, quelle surface de métal en $\text{m}^2$ est consommée ($1\text{ m}^2 = 10\,000\text{ cm}^2$) ?
\end{enumerate}
\end{minipage}\hfill
\begin{minipage}[c]{0.38\linewidth}
\centering
...
% ------------------------------------------------------------------------------
\begin{exercice}[3 pts][\capAnalyser]{Silo à Grains Agricole avec Trémie Conique \& Masse de Blé}
\noindent
\begin{minipage}[c]{0.58\linewidth}
Un silo à grains comprend une cuve cylindrique ($r = 2\text{ m}, h_1 = 6\text{ m}$) et une trémie conique ($h_2 = 1{,}50\text{ m}$).
\begin{enumerate}[leftmargin=1.2em, itemsep=1pt]
    \item \capRealiser\ Calculer le volume total de stockage $V$ en $\text{m}^3$ (arrondir au dixième).
    \item \capValider\ Le blé a une masse volumique de $800\text{ kg/m}^3$. Déterminer la masse maximale de blé en tonnes ($1\text{ t} = 1\,000\text{ kg}$).
\end{enumerate}
\end{minipage}\hfill
\begin{minipage}[c]{0.38\linewidth}
\centering
...
\begin{exercice}[3 pts][\capValider]{Cuve Sphérique de Stockage de Gaz \& Peinture Anti-Corrosion}
\noindent
\begin{minipage}[c]{0.58\linewidth}
Une sphère de stockage de gaz industriel a un rayon $R = 3\text{ m}$.
\begin{enumerate}[leftmargin=1.2em, itemsep=1pt]
    \item \capRealiser\ Calculer la surface extérieure $S = 4\pi R^2$ à peindre (au $\text{m}^2$).
    \item \capValider\ Un pot de peinture de $5\text{ L}$ couvre $30\text{ m}^2$. Deux couches sont requises. Combien de pots faut-il acheter ?
    \item \capRealiser\ Calculer le volume de gaz contenu en $\text{m}^3$ puis en litres.
\end{enumerate}
\end{minipage}\hfill
\begin{minipage}[c]{0.38\linewidth}
\centering
...
\begin{exercice}[3 pts][\capRealiser]{Volume sous Comble \& Isolation d'un Toit Pyramidal}
\noindent
\begin{minipage}[c]{0.58\linewidth}
Un pavillon carré de côté $a = 9\text{ m}$ a un toit pyramidal de hauteur $h = 3{,}50\text{ m}$.
\begin{enumerate}[leftmargin=1.2em, itemsep=1pt]
    \item \capRealiser\ Calculer le volume d'air total sous comble ($V = \frac{1}{3}\mathcal{B}h$).
    \item \capValider\ On souffle de la laine isolante sur une épaisseur de $30\text{ cm}$ ($0{,}30\text{ m}$) au sol. Calculer le volume de laine en $\text{m}^3$.
\end{enumerate}
\end{minipage}\hfill
\begin{minipage}[c]{0.38\linewidth}
\centering
...
% ------------------------------------------------------------------------------
\begin{exercice}[3 pts][\capAnalyser]{Verre Conique \& Réduction de Volume à Mi-Hauteur}
\noindent
\begin{minipage}[c]{0.58\linewidth}
Un verre à cocktail conique a un rayon de $r = 4\text{ cm}$ et une hauteur $h = 9\text{ cm}$.
\begin{enumerate}[leftmargin=1.2em, itemsep=1pt]
    \item \capRealiser\ Calculer la contenance totale à ras bord en $\text{cm}^3$ et en $\text{cL}$.
    \item \capAnalyser\ Un serveur remplit le verre à mi-hauteur ($k = 0{,}5$). Par quel coefficient le volume est-il multiplié ($k^3$) ?
    \item \capValider\ En déduire le volume servi. Le verre est-il à moitié plein ?
\end{enumerate}
\end{minipage}\hfill
\begin{minipage}[c]{0.38\linewidth}
\centering
...
\begin{exercice}[4 pts][\capRealiser]{Remplissage, Traitement \& Coût d'une Piscine Municipale}
\noindent
\begin{minipage}[c]{0.58\linewidth}
Un bassin municipal mesure $L = 25\text{ m}$, $l = 10\text{ m}$ et profondeur $p = 2\text{ m}$.
\begin{enumerate}[leftmargin=1.2em, itemsep=1pt]
    \item \capRealiser\ Calculer le volume d'eau en $\text{m}^3$ puis en litres.
    \item \capRealiser\ Le prix de l'eau est de $4{,}20\text{ \euro/m}^3$. Calculer le coût du remplissage.
    \item \capValider\ Avec une pompe de débit $20\text{ m}^3/\text{h}$, déterminer la durée nécessaire en heures pour remplir le bassin.
\end{enumerate}
\end{minipage}\hfill
\begin{minipage}[c]{0.38\linewidth}
\centering
