...
\begin{itemize}
    \item \textbf{Offre A} : Sans abonnement, $0{,}15\text{ \euro}$ la minute d'appel : $A(x) = 0{,}15x$.
    \item \textbf{Offre B} : Abonnement fixe de $12\text{ \euro}$ par mois puis $0{,}05\text{ \euro}$ la minute : $B(x) = 0{,}05x + 12$.
\end{itemize}
\begin{enumerate}
...
\begin{itemize}
    \item \textbf{Tarif Plein} : $18\text{ \euro}$ par séance de 2 heures.
    \item \textbf{Tarif Club (avec adhésion)} : Carte annuelle à $40\text{ \euro}$ puis $10\text{ \euro}$ par séance de 2 heures.
\end{itemize}
...
2. $A(60) = 0{,}15 \times 60 = 9\text{ \euro}$ ; $B(60) = 0{,}05 \times 60 + 12 = 15\text{ \euro}$. \\
...
2. (a) Pour 3 séances au tarif plein : $18 \times 3 = 54\text{ \euro}$ (graphiquement ordonnée 2,7). \\
(b) L'intersection a lieu pour \textbf{5 séances}, le montant est de \textbf{90 \euro}. \\
(c) Pour 8 séances : $T_1(8) = 144\text{ \euro}$ et $T_2(8) = 120\text{ \euro}$. Le **Tarif Club** est plus avantageux, économie de $144 - 120 = \repbox{24\text{ \euro}}$. \\
