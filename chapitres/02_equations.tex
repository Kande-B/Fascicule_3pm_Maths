...
Un plombier applique un forfait déplacement de $45\euro$ et un tarif horaire de $38\euro$ de l'heure.
Une facture totale s'élève à $159\euro$ TTC.
\begin{enumerate}
...
\begin{itemize}
    \item \textbf{Agence RapideLoc} : Forfait journalier de $60\euro$ plus $0{,}25\euro$ par kilomètre parcouru.
    \item \textbf{Agence EcoDrive} : Forfait journalier de $30\euro$ plus $0{,}40\euro$ par kilomètre parcouru.
\end{itemize}
...
\begin{enumerate}
    ...
    $C_1(100) = 0{,}25 \times 100 + 60 = 25 + 60 = 85\euro$. \\
    $C_2(100) = 0{,}40 \times 100 + 30 = 40 + 30 = 70\euro$. EcoDrive est la moins chère.
    \item $60 - 30 = 0{,}40x - 0{,}25x \implies 30 = 0{,}15x \implies x = \frac{30}{0{,}15} = \repbox{200}$.
    \item Pour une distance de \textbf{200 km}, les deux agences facturent exactement le même tarif ($110\euro$).
    \item Pour $x = 350\text{ km} > 200\text{ km}$, c'est l'agence **RapideLoc** qui est la plus économique ($C_1(350) = 147{,}50\euro$ contre $C_2(350) = 170\euro$).
\end{enumerate}
\end{solution}
