...
\begin{tikzpicture}[scale=0.55]
    ...
    \node[above, font=\bfseries\tiny] at (A) {$A$};
    \node[below left, font=\bfseries\tiny] at (B) {$B$};
    \node[below right, font=\bfseries\tiny] at (C) {$C$};
    \node[left, font=\bfseries\tiny] at (M) {$M$};
    \node[right, font=\bfseries\tiny] at (N) {$N$};
    \node[below=1pt, font=\bfseries\tiny] at (1.2,0) {1. Imbriqué};

    % Config 2 : Sablier
    \coordinate (A2) at (4.6,1.0);
    \coordinate (B2) at (3.6,2.0);
    \coordinate (C2) at (5.6,2.0);
    \coordinate (M2) at (3.8,0);
    \coordinate (N2) at (5.4,0);
    ...
    \node[right, font=\bfseries\tiny] at (A2) {$A$};
    \node[above left, font=\bfseries\tiny] at (B2) {$B$};
    \node[above right, font=\bfseries\tiny] at (C2) {$C$};
    \node[below left, font=\bfseries\tiny] at (M2) {$M$};
    \node[below right, font=\bfseries\tiny] at (N2) {$N$};
    \node[below=1pt, font=\bfseries\tiny] at (4.6,0) {2. Sablier};
\end{tikzpicture}
\end{minipage}
\end{cadredef}
