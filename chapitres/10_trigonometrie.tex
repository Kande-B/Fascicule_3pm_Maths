...
\begin{enumerate}[leftmargin=1.2em, itemsep=2pt]
    \item Calculer la hauteur $BC$ sous faîtage (au centième).
    \item Calculer la portée horizontale $AB$ (au centième).
\end{enumerate}
\end{minipage}\hfill%
...
\noindent\begin{minipage}[t]{0.52\linewidth}
Une grande échelle $L = 12\text{ m}$ ($PM$) est posée contre un mur avec un angle au sol de \textbf{$70^\circ$}.
\begin{enumerate}[leftmargin=1.2em, itemsep=2pt]
