...
\begin{enumerate}
    ...
    \item Le grillage est vendu en rouleaux de $25\text{ m}$ à $48\euro$ l'unité. Déterminer le coût total d'achat.
\end{enumerate}
\lignesreponse[6]
\end{exercice}
...
\begin{itemize}
    \item \textbf{Formule A} : $50\euro$ de forfait déplacement $+ 35\euro$ par heure : $T_A(x) = 35x + 50$
    \item \textbf{Formule B} : $20\euro$ de forfait $+ 42\euro$ par heure : $T_B(x) = 42x + 20$
\end{itemize}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Les lames coûtent $32\euro/\text{m}^2$. Calculer le montant total du bois nécessaire.
    \end{enumerate}
\end{enumerate}
\lignesreponse[6]
\end{sujetdnb}
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Nombre de rouleaux : $88 / 25 = 3{,}52 \implies$ il faut \textbf{4 rouleaux}. Coût : $4 \times 48 = \repbox{192\euro}$.
    \end{enumerate}
\end{itemize}
\end{solution}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Coût du bois : $29 \times 32 = \repbox{928\euro}$.
    \end{enumerate}
\end{enumerate}
\end{solution}
